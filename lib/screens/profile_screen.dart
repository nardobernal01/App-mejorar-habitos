...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // 1. SCAFFOLD EXTERNO (Pinta todo el fondo de la pantalla de PC)
    return Scaffold(
      backgroundColor: Theme.of(context).scaffoldBackgroundColor,
      body: Center(
        child: ConstrainedBox(
          constraints: const BoxConstraints(maxWidth: 600),
          // 2. SCAFFOLD INTERNO (Finge ser la pantalla del celular)
          child: Scaffold(
            backgroundColor:
                Colors.transparent, // Deja ver el color de fondo externo
            // ¡EL APPBAR VA AQUÍ ADENTRO PARA QUE NO SE ESTIRE!
            appBar: AppBar(
              title: const Text(
                "Mi Perfil",
